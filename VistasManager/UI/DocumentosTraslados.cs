...
{
    public partial class DocumentosTraslados : Estilos.FormMantenimiento
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (_sesion.USUARIO.Kerveros(Sesion.CLS.Comandos.ELIMINAR_DETALLE_DOCUMENTO_TRASLADOS, true))
                {
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            try
            {
                DocumentosTrasladosEditor _editor = new DocumentosTrasladosEditor();
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DocumentosTrasladosGuardar _editor = new DocumentosTrasladosGuardar(new ModelosManager.CLS.DocumentosEncabezados(_row));
        ...
        private void dgvDetalle_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                if (_item.Existe)
                {
                    _item.FormatoVenta.Valor = _sugerido;
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRow _row = dgvCatalogo.CurrentRow.ToDataRow();
                DocumentosTrasladosEditor _editor = new DocumentosTrasladosEditor(_row["IDDocumento"].TextoToEntero());
                _editor.doRefrescarFormularioExterno += Iniciar;
                _editor.ShowDialog(this);
            }
            catch (Exception _err)
        ...
        private void GenerarReporte(CLS.Enumeraciones.EXPORTAR _exportar)
        {
            ...
            {
                DataRow _row = dgvCatalogo.CurrentRow.ToDataRow();
                DataTable _dtrepo = ModelosManager.CLS.Consultas.HojaTraslados(_row["IDDocumento"].TextoToEntero());

                REPORTES.HojaTraslado _repo = new REPORTES.HojaTraslado();
                _repo.SetDataSource(_dtrepo);
        ...
        {
            //e.Cancel = CLS.ExtensionesLocales.ValidarExistenciaEnCeldaGrid(dgvDetalle, e, "CantidadSalida");
        }
    }
}
