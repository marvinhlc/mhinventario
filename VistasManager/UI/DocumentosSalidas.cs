...
{
    public partial class DocumentosSalidas : Estilos.FormMantenimiento
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (_sesion.USUARIO.Kerveros(Sesion.CLS.Comandos.ELIMINAR_DOCUMENTO_SALIDAS, true))
                {
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DocumentosSalidasGuardar _editor = new DocumentosSalidasGuardar(new ModelosManager.CLS.DocumentosEncabezados(_row));
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            try
            {
                if (_sesion.USUARIO.Kerveros(Sesion.CLS.Comandos.ELIMINAR_DETALLE_DOCUMENTO_SALIDAS, true))
                {
        ...
        private void GenerarReporte(CLS.Enumeraciones.EXPORTAR _exportar)
        {
            ...
            {
                DataRow _row = dgvCatalogo.CurrentRow.ToDataRow();
                DataTable _dtrepo = ModelosManager.CLS.Consultas.HojaSalida(_row["IDDocumento"].TextoToEntero());

                REPORTES.HojaSalidas _repo = new REPORTES.HojaSalidas();
