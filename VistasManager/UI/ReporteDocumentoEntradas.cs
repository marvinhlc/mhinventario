...
{
    public partial class ReporteDocumentoEntradas : Estilos.FormEditores
    {
        ...
        public ReporteDocumentoEntradas()
        {
        ...
        private void GenerarReporte(string _pformato = "VP")
        {
            ...
            try
            {
                ...
                VistasManager.REPORTES.DocumentosEntradas _repo = new REPORTES.DocumentosEntradas();
