...
{
    public partial class DocumentosVentasGuardar : Estilos.FormEditores
    {
        ...
        public DocumentosVentasGuardar(int _pidpersona = 0)
        {
        ...
        public DocumentosVentasGuardar(ModelosManager.CLS.DocumentosEncabezados _pdoc)
        {
            _documento = _pdoc;
            InitializeComponent();
            Iniciar();
        ...
        private void cbbClientes_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                _clientes = new ModelosManager.CLS.PersonasNombres(cbbClientes.SelectedValue.TextoToEntero());
                if (_clientes.Existe)
                {
