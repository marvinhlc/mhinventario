...
{
    public partial class DocumentosEntradas : Estilos.FormMantenimiento
    {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                if (_sesion.USUARIO.Kerveros(Sesion.CLS.Comandos.ELIMINAR_DETALLE_DOCUMENTO_ENTRADAS, true))
                {
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            try
            {
                DocumentosEntradasEditor _editor = new DocumentosEntradasEditor();
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DocumentosEntradasGuardar _editor = new DocumentosEntradasGuardar(new ModelosManager.CLS.DocumentosEncabezados(_row));
        ...
        private void toolStripButton3_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRow _row = dgvCatalogo.CurrentRow.ToDataRow();
                DocumentosEntradasEditor _editor = new DocumentosEntradasEditor(_row["IDDocumento"].TextoToEntero());
                _editor.doRefrescarFormularioExterno += Iniciar;
                _editor.ShowDialog(this);
            }
            catch (Exception _err)
