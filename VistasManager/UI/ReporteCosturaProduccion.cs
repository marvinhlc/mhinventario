    ...
    public partial class ReporteCosturaProduccion : Estilos.FormEditores
    {
        ...
        private void GenerarReporte(string _pformato = "VP")
        {
            ...
            try
            {
                ...
                _tabla = ModelosManager.CLS.Consultas.ReporteCosturaProduccion(
                    dtpFechaInicial.Value.FechaParaMySQL(),
                    dtpFechaFinal.Value.FechaParaMySQL(),
                    _estado,
                    txbCostureraSastre.Text
                );

                VistasManager.REPORTES.ReporteCosturaProduccion _repo = new REPORTES.ReporteCosturaProduccion();
